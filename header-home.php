...
<div class="site-page-header o-has-img o-custom-content" style="background-image: url(<?php echo wp_get_attachment_url( get_post_thumbnail_id( ) )  ?>);">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 style="text-align: center;"><?php the_title(); ?></h1>
                <p style="text-align: center;"><?php get_bloginfo('description') ?></p>
                <p style="text-align: center;"><a class="site-btn o-lg o-white" href="/who-we-are">Learn More</a></p>
            </div>
        </div>
    </div>
</div>
